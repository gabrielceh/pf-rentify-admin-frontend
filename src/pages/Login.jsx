...
const Login = () => {
	return (
		<div
			className='grid place-content-center min-h-screen bg-no-repeat bg-cover bg-center p-4 md:p-8'
			...
			<section className='flex flex-col justify-center items-center gap-5 mb-12'>
				...
				<h3 className='text-center text-xl md:text-3xl'>Sign in to your account</h3>
			</section>
